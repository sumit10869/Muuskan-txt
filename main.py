...
bot = Client("bot",
             bot_token= "7189377174:AAFAy9mdlVhabsidVOPkhLRf9zmBLsfns0w",
             api_id= 21513517,
...
🤖𝐌𝐚𝐝𝐞 𝐁𝐲  : [๛𝐌𝐑๛𝐒𝐀𝐓𝐘𝐀𝐌๛](http://t.me/MRSATYAM01) """, reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("✜ 𝐌𝐮𝐬𝐭 𝐉𝐨𝐢𝐧 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 ✜" ,url=f"https://t.me/neetumamvol2") ],
                    [
                    InlineKeyboardButton("✜◆ 𝐂𝐨𝐧𝐭𝐚𝐜𝐭 ◆✜" ,url="https://t.me/MRSATYAM01") ]                               
            ]))
...
async def account_login(bot: Client, m: Message):
    ...
    await editable.edit("**✏️ 𝐍𝐨𝐰 𝐄𝐧𝐭𝐞𝐫 𝐀 𝐂𝐚𝐩𝐭𝐢𝐨𝐧 𝐭𝐨 𝐚𝐝𝐝 𝐜𝐚𝐩𝐭𝐢𝐨𝐧 𝐨𝐧 𝐲𝐨𝐮𝐫 𝐮𝐩𝐥𝐨𝐚𝐝𝐞𝐝 𝐟𝐢𝐥𝐞 𝐎𝐭𝐡𝐞𝐫𝐰𝐢𝐬𝐞 𝐬𝐞𝐧𝐝**   **`๛𝐌𝐑๛𝐒𝐀𝐓𝐘𝐀𝐌๛`**")
    input3: Message = await bot.listen(editable.chat.id)
    raw_text3 = input3.text
    await input3.delete(True)
    highlighter  = f"️ ⁪⁬⁮⁮⁮"
    if raw_text3 == '๛𝐌𝐑๛𝐒𝐀𝐓𝐘𝐀𝐌๛':
        MR = highlighter 
    else:
        MR = raw_text3
        ...
        for i in range(count - 1, len(links)):
            ...
            try:  
                ...
                if "drive" in url:
                    ...
                    Show = f"**❊⟱𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝𝐢𝐧𝐠 ⟱❊ »**\n\n**📝 𝐍𝐚𝐦𝐞 »** `{name}\n⌨ 𝐐𝐮𝐥𝐢𝐭𝐲 » {raw_text2}`\n\n**🔗 𝐔𝐑𝐋 »** `{url}`\n\n🤖𝐌𝐚𝐝𝐞 𝐁𝐲  : [๛𝐌𝐑๛𝐒𝐀𝐓𝐘𝐀𝐌๛](http://t.me/MRSATYAM01)\n"
    ...
    await m.reply_text("**🚦𝐃𝐨𝐧𝐞🚦\n𝐒𝐛 𝐍𝐢𝐤𝐚𝐥 𝐃𝐢𝐲𝐚 𝐁𝐚𝐛𝐞💕\n 𝐌𝐔𝐒𝐓 𝐉𝐎𝐈𝐍 [๛𝐌𝐑๛𝐒𝐀𝐓𝐘𝐀𝐌๛](http://t.me/MRSATYAM01)**")
